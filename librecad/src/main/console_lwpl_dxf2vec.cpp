/******************************************************************************
**
** File was created for the C3D's fork of LibreCAD project, a 2D CAD program.
**
** Copyright (C) LibreCAD & Constructions-3D
**
...
/////////
/// \brief console_lwpl_dxf2vec is called if librecad
/// as console lwpl_dxf2vec tool for converting a LWPolyline DXF to a vector of points.
/// \param argc
/// \param argv
/// \return
///
int console_lwpl_dxf2vec(int argc, char* argv[])
{
